...
**Goal**: Enable users to deploy network topology by running `nvair create -d <directory>` and receive simulation ID
...
**Goal**: Enable users to validate topology configuration without creating simulation using `nvair create -d <directory> --dry-run`
...
**Goal**: Enable users to delete simulations with confirmation using `nvair delete simulation <name>`
...
**Goal**: Enable users to delete service forwarding rules with confirmation using `nvair delete service <name>`
...
- [ ] T067 Build binary and verify `nvair create` and `nvair delete` commands available
...
- After Phase 3: `git commit -am "feat: Implement nvair create command (US1)"`
- After Phase 4: `git commit -am "feat: Add dry-run validation (US2)"`
- After Phase 5: `git commit -am "feat: Implement nvair delete simulation (US3)"`
- After Phase 6: `git commit -am "feat: Implement nvair delete service (US4)"`
